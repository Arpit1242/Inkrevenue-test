...
const indentSizes = ['pl-0', 'pl-4', 'pl-6', 'pl-8'];
...
const { theme } = useTheme();
  ...
  return (
    <div className=" text-center px-4 py-12 space-y-6 sm:px-6 md:px-0">
          ...
          >
            {line.map((word, wordIndex) => {
              ...
              return (
                ...
                >
                  <span className=""style={{color: "var(--text-color3)"}}>{word}</span>
      ...
      >
        We drive real results for global brands through performance-first advertising and precision targeting.
      </motion.p>
